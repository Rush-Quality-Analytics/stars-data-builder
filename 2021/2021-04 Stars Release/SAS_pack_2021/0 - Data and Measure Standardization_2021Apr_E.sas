...
/*This file is used to derive analysis data 'Std_data_2021Apr_analysis', which will be used in programs 1 and 2*/
%LET PATH1=H:\Star Rating\2021\2021 Apr SAS pack\input data ; /* For 2021 APr released data, MUST BE CHANGED */
%LET PATH2=H:\Star Rating\2021\2021 Apr SAS pack\derived data ; /* For derived data sets, MUST BE CHANGED */
%LET PATH3=H:\Star Rating\2021\2021 Apr SAS pack ; /* For SAS macros , MUST BE CHANGED  */

LIBNAME HC "&PATH1";
LIBNAME R "&PATH2";

%INCLUDE "&path3.\Star_Macros_E_peer.sas";/*calling macros*/
...
/* measures on Hospital Campare in 2021 Apr, after excluding re_tired measures, no_directional measures, 
...
OP_3b OP_18b ED_2b	 
OP_8 OP_10 OP_13		
OP_2;*Apr. 2021: 6 measures are retired:IMM-2 VTE-6 ED-1b OP-5 OP-11 OP-14, 3 measures are added: OP_35_ADM OP_35_ED OP_36;
...
/*** Here are ALL 7 Mortality measures in 2021 Apr  ***/
...
/*** Here are ALL 8 SAFETY measures in 2021 Apr  ***/
if measure_in_name in /*- MUST CHECK NEXT LINE AND UPDATE FOR EACH QUARTER DATA IF NEW MEASURE ADDED/REMOVED IN THIS QUARTER*/ 
...
/*** Here are ALL 11 READMISSION measures in 2021 Apr  ***/
if measure_in_name in /*- MUST CHECK NEXT LINE AND UPDATE FOR EACH QUARTER DATA IF NEW MEASURE ADDED/REMOVED IN THIS QUARTER*/ 
('EDAC_30_AMI', 'EDAC_30_HF', 'EDAC_30_PN', 'OP_32','READM_30_CABG', 'READM_30_COPD', 'READM_30_HIP_KNEE', 
'READM_30_HOSP_WIDE', 'OP_35_ADM', 'OP_35_ED', 'OP_36');*newly added in Apr.2021: 'OP_35_ADM', 'OP_35_ED', 'OP_36';
RUN;
...
/*** Here are ALL 8 PATIENT EXPERIENCE measures in 2021 Apr ***/
if measure_in_name in /*- MUST CHECK NEXT LINE AND UPDATE FOR EACH QUARTER DATA IF NEW MEASURE ADDED/REMOVED IN THIS QUARTER*/ 
...
/*** Here are ALL 15 Process measures in 2021 Apr ***/
if measure_in_name in /*- MUST CHECK NEXT LINE AND UPDATE FOR EACH QUARTER DATA IF NEW MEASURE ADDED/REMOVED IN THIS QUARTER*/ 

('IMM_3', 'OP_22', 'OP_23',  'OP_29', 'OP_30','OP_33', 'PC_01', 'SEP_1',
'ED_2B', 'OP_2', 'OP_3B', 'OP_18B',
'OP_8', 'OP_10', 'OP_13');
RUN;
...
/* OUTPUTS OF 'std_data_2021Apr_analysis' ARE GENERATED*/
...
/*Continue to "1 - First stage_Simple Average of Measure Scores_2021Apr_E" SAS progam*/
