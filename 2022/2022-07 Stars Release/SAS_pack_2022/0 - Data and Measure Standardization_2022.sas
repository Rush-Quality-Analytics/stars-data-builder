...
/*This file is used to derive analysis data 'Std_data_2022qrt_analysis', which will be used in programs 1 and 2*/
%LET PATH1=H:\Star Rating\2022\2022 Qrt SAS pack\input data ; /* For 2022 Qrt released data, MUST BE CHANGED */
%LET PATH2=H:\Star Rating\2022\2022 Qrt SAS pack\derived data ; /* For derived data sets, MUST BE CHANGED */
%LET PATH3=H:\Star Rating\2022\2022 Qrt SAS pack ; /* For SAS macros , MUST BE CHANGED  */
...
/*proc contents data=HC.All_data_&year.&quarter.;run;*/

/* measures on Hospital Campare in 2022, after excluding re_tired measures, no_directional measures, 
...
OP_3b OP_18b /*ED_2b*/	 
OP_8 OP_10 OP_13		
OP_2;*OP_30 and ED_2b are removed;
...
'READM_30_HOSP_WIDE', 'OP_35_ADM', 'OP_35_ED', 'OP_36');*newly added: 'OP_35_ADM', 'OP_35_ED', 'OP_36';
RUN;
...
/* OUTPUTS OF 'std_data_2022qrt_analysis' ARE GENERATED*/
...
/*Continue to "1 - First stage_Simple Average of Measure Scores_2022" SAS progam*/
