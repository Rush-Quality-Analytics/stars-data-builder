...
from Outcomes_mortality;/*Outcomes_mortality is generated from the SAS program '0 - Data and Measure Standardization_2023Jul'*/
QUIT;
...
select count(measure_in_name)
into: measure_OS_cnt
from Outcomes_safety;/*Outcomes_safety is generated from the SAS program '0 - Data and Measure Standardization_2023Jul'*/
QUIT;
...
select count(measure_in_name)
into: measure_OR_cnt
from Outcomes_readmission;/*Outcomes_readmission is generated from the SAS program '0 - Data and Measure Standardization_2023Jul'*/
QUIT;
...
from Ptexp;/*Ptexp is generated from the SAS program '0 - Data and Measure Standardization_2023Jul'*/
QUIT;
...
from Process;/*Process is generated from the SAS program '0 - Data and Measure Standardization_2023Jul'*/
QUIT;
...
/*Continue to "2 - Second Stage_Weighted Average and Categorize Star_2023Jul" SAS progam*/
