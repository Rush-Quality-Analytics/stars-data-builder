...
HC <- "/Users/kenlocey/GitHub/stars-data-builder/2026/2026-05_Stars_Release"
R <- "/Users/kenlocey/GitHub/stars-data-builder/2026/2026-05_Stars_Release/R_CSV_output"


# Load data 
HC_all_data <- file.path(HC, paste0("stars_alldata_", year, quarter, ".csv"))
...
Std_data$Hybrid_HWM_RSMR <- -Std_data$Hybrid_HWM_RSMR  #Hybrid_HWM_RSMR is added in Year 2026
...
#MORTALITY
measure_OM0<-c('std_MORT_30_AMI', 'std_MORT_30_CABG', 'std_MORT_30_COPD', 'std_MORT_30_HF', 'std_MORT_30_PN', 'std_MORT_30_STK', 'std_PSI_4_SURG_COMP', 'std_Hybrid_HWM_RSMR')
